...
36,0,0,2,0,0,17,114,0,0,1,1,0,1,0,1,97,0,0,
55,0,0,2,0,0,45,120,0,0,0,0,0,1,0,
70,0,0,2,0,0,13,129,0,0,4,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
101,0,0,2,0,0,15,160,0,0,0,0,0,1,0,
116,0,0,3,0,0,29,162,0,0,0,0,0,1,0,
131,0,0,4,0,0,31,204,0,0,0,0,0,1,0,
};
...
/* EXEC SQL END DECLARE SECTION; */ 
   ...
   /* 실행시킬 SQL 문장*/
   sprintf(dynstmt,"SELECT j_name, j_social_num , j_sal,  case when j_sal between 0 and 100 then '1분위'   when j_sal between 101 and 1000 then '2분위'  when j_sal  between 1001 and 10000 then '3분위'  when j_sal  between 10001 and 100000 then '4분위'   when j_sal > 100000 then '5분위' end 소득분위 FROM jumin WHERE to_char(j_name) LIKE '%%%s%%' and  j_social_num LIKE '%%%s%%' ",  no_temp1, no_temp2);
...

{
   ...
   for (;;)
    {
        /* EXEC SQL FETCH c_cursor INTO :j_name, : j_social_num, :j_sal, :j_sal_quint; */ 

{
        ...
        sqlstm.sqadto[0] = (unsigned short )0;
        sqlstm.sqtdso[0] = (unsigned short )0;
        sqlstm.sqhstv[1] = (         void  *)&j_social_num;
        ...
        sqlstm.sqhstv[3] = (         void  *)&j_sal_quint;
