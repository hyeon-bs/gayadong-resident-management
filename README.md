...
## 📝 프로젝트 개요
주민센터 행정 업무의 효율성을 극대화하기 위해 주민 정보 관리 및 맞춤형 복지 혜택 대상자를 조회·관리하는 행정 자동화 시스템입니다. Oracle DB와 Pro*C(Embedded SQL) 환경을 구축하여 대량의 주민 데이터를 안정적으로 처리하고, 동적 쿼리를 통한 맞춤형 필터링 알고리즘을 구현했습니다.
